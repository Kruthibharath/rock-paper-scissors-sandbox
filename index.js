...
const updateDOM = (moveOne, moveTwo, outcome) => {
  ...
  const player1 = document.getElementById("player-one-move__img");
  player1.src = `./images/${moveOne}.png`;

  const player2 = document.getElementById("player-two-move__img");
  player2.src = `./images/${moveTwo}.png`;
